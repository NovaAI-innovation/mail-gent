...
**Source:** https://docs.agno.com/models/providers/gateways/groq/usage/deep-knowledge.md
**Section:** Docs
...
```python cookbook/11_models/groq/deep_knowledge.py theme={null}
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install -U openai lancedb tantivy inquirer agno groq
    ```
  </Step>

  <Step title="Run Agent">
    ```bash  theme={null}
    python cookbook/11_models/groq/deep_knowledge.py
    ```
  </Step>
</Steps>
