...
**Source:** https://docs.agno.com/integrations/discord/usage/agent-with-user-memory.md
**Section:** Docs
...
```python cookbook/13_integrations/discord/agent_with_user_memory.py theme={null}
