...
**Source:** https://docs.agno.com/hitl/usage/confirmation-required-stream-async.md
**Section:** Docs

**Description:** This example demonstrates human-in-the-loop functionality with asynchronous streaming responses. It shows how to handle user confirmation during tool execution in an async environment while maintaining real-time streaming.
