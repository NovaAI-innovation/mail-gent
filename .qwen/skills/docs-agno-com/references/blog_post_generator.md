...
**Source:** https://docs.agno.com/cookbook/workflows/blog-post-generator.md
**Section:** Docs
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install -U agno openai ddgs pycountry newspaper4k lxml_html_clean sqlalchemy fastapi
    ```
  </Step>
