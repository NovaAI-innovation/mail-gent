...
**Source:** https://docs.agno.com/hitl/usage/confirmation-required-with-history.md
**Section:** Docs

**Description:** This example demonstrates human-in-the-loop functionality while maintaining conversation history. It shows how user confirmation works when the agent has access to previous conversation context.
