...
**Source:** https://docs.agno.com/cookbook/agents/web-extraction-agent.md
**Section:** Docs
...
```python web_extraction_agent.py theme={null}
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install -U agno openai firecrawl-py
    ```
  </Step>
...
* Explore [Firecrawl Tools](/tools/toolkits/web-scrape/firecrawl) for advanced scraping options
