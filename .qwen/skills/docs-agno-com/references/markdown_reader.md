...
**Source:** https://docs.agno.com/knowledge/concepts/readers/markdown-reader.md
**Section:** Docs
...
```python examples/basics/knowledge/concepts/readers/overview/markdown_reader_sync.py theme={null}
