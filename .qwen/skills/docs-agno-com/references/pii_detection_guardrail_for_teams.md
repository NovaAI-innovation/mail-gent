...
**Source:** https://docs.agno.com/guardrails/usage/team/pii-detection.md
**Section:** Docs

**Description:** This example demonstrates how to use Agno's built-in PII detection guardrail with a Team to protect sensitive data.
  ...
  <Step title="Create a Python file">
    ...
    async def main():
        ...
        team = Team(
            ...
            description="An team that helps with customer service while protecting privacy.",
