...
**Source:** https://docs.agno.com/production/aws/database-tables.md
**Section:** Docs
...
```python db/tables/user.py theme={null}
...
```python db/tables/__init__.py theme={null}
from db.tables.base import Base
...
```python db/tables/test_add_user.py theme={null}
from typing import Optional
