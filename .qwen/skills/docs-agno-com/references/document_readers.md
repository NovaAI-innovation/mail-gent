...
**Source:** https://docs.agno.com/cookbook/knowledge/readers.md
**Section:** Docs
...
> Extract text from PDF, CSV, JSON, Markdown, web content, and more.
...
```python cookbook/07_knowledge/readers/pdf_reader_async.py theme={null}
from agno.knowledge.knowledge import Knowledge
...
```python cookbook/07_knowledge/readers/pdf_reader_password.py theme={null}
from agno.knowledge.knowledge import Knowledge
from agno.knowledge.reader.pdf import PDFReader
...
```python cookbook/07_knowledge/readers/csv_reader.py theme={null}
from agno.knowledge.knowledge import Knowledge
...
```python cookbook/07_knowledge/readers/csv_field_labeled_reader.py theme={null}
from agno.knowledge.reader.csv import CSVReader
...
```python cookbook/07_knowledge/readers/json_reader.py theme={null}
from agno.knowledge.knowledge import Knowledge
...
```python cookbook/07_knowledge/readers/markdown_reader_async.py theme={null}
from agno.knowledge.knowledge import Knowledge
...
```python cookbook/07_knowledge/readers/pptx_reader.py theme={null}
from agno.knowledge.knowledge import Knowledge
...
```python cookbook/07_knowledge/readers/arxiv_reader.py theme={null}
from agno.knowledge.knowledge import Knowledge
...
```python cookbook/07_knowledge/readers/firecrawl_reader.py theme={null}
from agno.knowledge.knowledge import Knowledge
...
```python cookbook/07_knowledge/readers/tavily_reader.py theme={null}
from agno.knowledge.knowledge import Knowledge
