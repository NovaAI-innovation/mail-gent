...
**Source:** https://docs.agno.com/multimodal/team/usage/image-to-structured-output.md
**Section:** Docs
...
```python cookbook/02_examples/teams/multimodal/image_to_structured_output.py theme={null}
...
<Steps>
  ...
  <Step title="Install required libraries">
    ```bash  theme={null}
    uv pip install agno pydantic rich
    ```
  </Step>
