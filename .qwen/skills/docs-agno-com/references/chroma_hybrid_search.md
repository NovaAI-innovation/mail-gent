...
**Source:** https://docs.agno.com/knowledge/vector-stores/chroma/usage/chroma-hybrid-search.md
**Section:** Docs
...
```python cookbook/08_knowledge/vector_db/chroma_db/chroma_db_hybrid_search.py theme={null}
import asyncio
