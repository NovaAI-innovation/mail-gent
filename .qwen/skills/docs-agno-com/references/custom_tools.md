...
**Source:** https://docs.agno.com/cookbook/tools/custom-tools.md
**Section:** Docs
...
> Build custom tools with the @tool decorator for any functionality.
...
```python cookbook/91_models/tool_decorator/tool_decorator_async.py theme={null}
import httpx
from agno.agent import Agent
from agno.tools import tool
...
```python cookbook/91_models/tool_decorator/tool_decorator_with_instructions.py theme={null}
from agno.agent import Agent
from agno.tools import tool
...
```python cookbook/91_models/tool_decorator/cache_tool_calls.py theme={null}
from agno.agent import Agent
from agno.tools import tool
...
```python cookbook/91_models/tool_decorator/stop_after_tool_call.py theme={null}
from agno.agent import Agent
from agno.tools import tool
...
```python cookbook/91_models/tool_decorator/tool_decorator_on_class_method.py theme={null}
from agno.agent import Agent
from agno.tools import tool
...
cd agno/cookbook/91_models/tool_decorator
