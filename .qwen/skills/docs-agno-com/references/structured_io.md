...
**Source:** https://docs.agno.com/workflows/usage/structured-io-at-each-step-level.md
**Section:** Docs

**Description:** Type-safe data flow between agents, teams, and custom functions using Pydantic models.
