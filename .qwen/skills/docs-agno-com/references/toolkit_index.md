...
**Source:** https://docs.agno.com/tools/toolkits/overview.md
**Section:** Docs
...
<CardGroup cols={3}>
  <Card title="Web Search" icon="magnifying-glass" iconType="duotone" href="/tools/toolkits/search/websearch">
  ...
  <Card title="SerperApi" icon="magnifying-glass" iconType="duotone" href="/tools/toolkits/search/serpapi">
    Tools to search Google using SerperApi.
  </Card>

  <Card title="Serpapi" icon="magnifying-glass" iconType="duotone" href="/tools/toolkits/search/serper">
  ...
  <Card title="Valyu" icon="magnifying-glass" iconType="duotone" href="/tools/toolkits/search/valyu">
...
<CardGroup cols={3}>
  ...
  <Card title="Reddit" icon="reddit" iconType="brands" href="/tools/toolkits/social/reddit">
...
<CardGroup cols={3}>
  <Card title="AgentQL" icon="magnifying-glass" iconType="duotone" href="/tools/toolkits/web-scrape/agentql">
    Browse and scrape websites using AgentQL.
  </Card>

  <Card title="BrowserBase" icon="browser" iconType="duotone" href="/tools/toolkits/web-scrape/browserbase">
    Tools to interact with BrowserBase.
  </Card>

  <Card title="Crawl4AI" icon="spider" iconType="duotone" href="/tools/toolkits/web-scrape/crawl4ai">
    Tools to crawl web data.
  </Card>

  <Card title="Jina Reader" icon="robot" iconType="duotone" href="/tools/toolkits/web-scrape/jina-reader">
    Tools for neural search and AI services using Jina.
  </Card>

  <Card title="Newspaper" icon="newspaper" iconType="duotone" href="/tools/toolkits/web-scrape/newspaper">
    Tools to read news articles.
  </Card>

  <Card title="Newspaper4k" icon="newspaper" iconType="duotone" href="/tools/toolkits/web-scrape/newspaper4k">
    Tools to read articles using Newspaper4k.
  </Card>

  <Card title="Website" icon="globe" iconType="duotone" href="/tools/toolkits/web-scrape/website">
    Tools to scrape websites.
  </Card>

  <Card title="Firecrawl" icon="fire" iconType="duotone" href="/tools/toolkits/web-scrape/firecrawl">
    Tools to crawl the web using Firecrawl.
  </Card>

  <Card title="Spider" icon="spider" iconType="duotone" href="/tools/toolkits/web-scrape/spider">
    Tools to crawl websites.
  </Card>

  <Card title="Trafilatura" icon="text" iconType="duotone" href="/tools/toolkits/web-scrape/trafilatura">
    Tools to extract text content from web pages.
  </Card>

  <Card title="BrightData" icon="screen-users" iconType="duotone" href="/tools/toolkits/web-scrape/brightdata">
...
<CardGroup cols={3}>
  ...
  <Card title="Redshift" icon="database" iconType="duotone" href="/tools/toolkits/database/redshift">
  ...
  <Card title="Google BigQuery" icon="database" iconType="duotone" href="/tools/toolkits/database/google-bigquery">
    Tools to query large datasets using Google BigQuery.
  </Card>

  <Card title="Neo4j" icon="project-diagram" iconType="duotone" href="/tools/toolkits/database/neo4j">
  ...
  <Card title="MCP Toolbox" icon="database" iconType="duotone" href="/tools/mcp/mcp-toolbox">
...
<CardGroup cols={3}>
  ...
  <Card title="Local File System" icon="file" iconType="duotone" href="/tools/toolkits/local/local-file-system">
...
<CardGroup cols={3}>
  <Card title="Azure OpenAI" icon="microsoft" iconType="brands" href="/tools/toolkits/models/azure-openai">
  ...
  <Card title="Morph" icon="code" iconType="duotone" href="/tools/toolkits/models/morph">
    Tools to modify code using Morph AI.
  </Card>

  <Card title="Nebius" icon="image" iconType="duotone" href="/tools/toolkits/models/nebius">
...
<CardGroup cols={3}>
  ...
  <Card title="AWS Lambda" icon="server" iconType="duotone" href="/tools/toolkits/others/aws-lambda">
    Tools to run serverless functions using AWS Lambda.
  </Card>

  <Card title="AWS SES" icon="envelope" iconType="duotone" href="/tools/toolkits/others/aws-ses">
  ...
  <Card title="Custom API" icon="puzzle-piece" iconType="duotone" href="/tools/toolkits/others/custom-api">
  ...
  <Card title="Eleven Labs" icon="headphones" iconType="duotone" href="/tools/toolkits/others/eleven-labs">
  ...
  <Card title="Financial Datasets" icon="dollar-sign" iconType="duotone" href="/tools/toolkits/others/financial-datasets">
  ...
  <Card title="Google Maps" icon="map" iconType="duotone" href="/tools/toolkits/others/google-maps">
  ...
  <Card title="Google Sheets" icon="google" iconType="duotone" href="/tools/toolkits/others/google-sheets">
  ...
  <Card title="MLX Transcribe" icon="headphones" iconType="duotone" href="/tools/toolkits/others/mlx-transcribe">
    Tools to transcribe audio using MLX.
  </Card>

  <Card title="ModelsLabs" icon="video" iconType="duotone" href="/tools/toolkits/others/models-labs">
    Tools to generate videos using ModelsLabs.
  </Card>

  <Card title="Notion" icon="database" iconType="duotone" href="/tools/toolkits/others/notion">
    Tools to interact with Notion database.
  </Card>

  <Card title="Nano Banana" icon="image" iconType="duotone" href="/tools/toolkits/others/nano-banana">
  ...
  <Card title="Bitbucket" icon="bitbucket" iconType="brands" href="/tools/toolkits/others/bitbucket">
    Tools to interact with Bitbucket repositories.
  </Card>

  <Card title="Brandfetch" icon="trademark" iconType="duotone" href="/tools/toolkits/others/brandfetch">
    Tools to retrieve brand information and logos.
  </Card>

  <Card title="ClickUp" icon="tasks" iconType="duotone" href="/tools/toolkits/others/clickup">
    Tools to manage ClickUp tasks and projects.
  </Card>

  <Card title="Desi Vocal" icon="microphone" iconType="duotone" href="/tools/toolkits/others/desi-vocal">
    Tools for Indian text-to-speech synthesis.
  </Card>

  <Card title="EVM" icon="coins" iconType="duotone" href="/tools/toolkits/others/evm">
    Tools to interact with Ethereum blockchain.
  </Card>

  <Card title="Knowledge" icon="brain" iconType="duotone" href="/tools/toolkits/others/knowledge">
    Tools to search and analyze knowledge bases.
  </Card>

  <Card title="Mem0" icon="memory" iconType="duotone" href="/tools/toolkits/others/mem0">
  ...
  <Card title="OpenCV" icon="camera" iconType="duotone" href="/tools/toolkits/others/opencv">
    Tools for computer vision and camera operations.
  </Card>

  <Card title="Reasoning" icon="brain" iconType="duotone" href="/tools/toolkits/others/reasoning">
    Tools for structured logical analysis.
  </Card>

  <Card title="Shopify" icon="shopify" iconType="brands" href="/tools/toolkits/others/shopify">
    Tools to interact with Shopify.
  </Card>

  <Card title="Spotify" icon="spotify" iconType="brands" href="/tools/toolkits/others/spotify">
    Tools to search for songs using Spotify.
  </Card>

  <Card title="User Control Flow" icon="user-check" iconType="duotone" href="/tools/toolkits/others/user-control-flow">
    Tools for interactive user input collection.
  </Card>

  <Card title="Visualization" icon="chart-bar" iconType="duotone" href="/tools/toolkits/others/visualization">
    Tools for data visualization and charting.
  </Card>

  <Card title="WebTools" icon="globe" iconType="duotone" href="/tools/toolkits/others/webtools">
