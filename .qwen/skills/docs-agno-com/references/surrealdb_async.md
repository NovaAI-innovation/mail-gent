...
**Source:** https://docs.agno.com/knowledge/vector-stores/surrealdb/usage/async-surreal-db.md
**Section:** Docs
...
```python cookbook/08_knowledge/vector_db/surrealdb/async_surreal_db.py theme={null}
import asyncio
...
<Steps>
  ...
  <Step title="Run Agent">
    ```bash  theme={null}
    python cookbook/08_knowledge/vector_db/surrealdb/async_surreal_db.py
    ```
  </Step>
</Steps>
