...
**Source:** https://docs.agno.com/hitl/external-execution.md
**Section:** Docs
...
<CardGroup cols={2}>
  <Card title="Basic External Execution" icon="plug" href="/hitl/usage/external-tool-execution">
    Execute tools outside the agent's control
  </Card>

  <Card title="Async External Execution" icon="bolt" href="/hitl/usage/external-tool-execution-async">
    Using external execution with async agents
  </Card>

  <Card title="Streaming External Execution" icon="water" href="/hitl/usage/external-tool-execution-stream-async">
    External execution with streaming responses
  </Card>

  <Card title="Toolkit External Execution" icon="toolbox" href="/hitl/usage/external-tool-execution-toolkit">
