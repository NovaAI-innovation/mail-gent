...
**Source:** https://docs.agno.com/multimodal/team/usage/generate-image-with-team.md
**Section:** Docs
...
This example demonstrates how an Agno Agent Team can collaborate to generate high-quality images using a prompt engineer to optimize prompts and an image creator to generate images with DALL-E.

## Code

```python cookbook/02_examples/teams/multimodal/generate_image_with_team.py theme={null}
...
<Steps>
  ...
  <Step title="Run the agent">
    ```bash  theme={null}
    python cookbook/02_examples/teams/multimodal/generate_image_with_team.py
    ```
  </Step>
</Steps>
