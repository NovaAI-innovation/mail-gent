...
**Source:** https://docs.agno.com/sessions/metrics/agent.md
**Section:** Docs

**Description:** Agent run and session metrics for token usage and performance.
...
> Agent run and session metrics for token usage and performance.
