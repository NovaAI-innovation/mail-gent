...
**Source:** https://docs.agno.com/database/providers/redis/usage/redis-for-workflow.md
**Section:** Docs
...
"""
Run: `uv pip install openai httpx newspaper4k redis agno` to install the dependencies
"""
