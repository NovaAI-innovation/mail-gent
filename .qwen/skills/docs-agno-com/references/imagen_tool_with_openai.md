...
**Source:** https://docs.agno.com/models/providers/native/google/usage/imagen-tool.md
**Section:** Docs
...
```python cookbook/11_models/google/gemini/imagen_tool.py theme={null}
...
<Steps>
  ...
  <Step title="Run Agent">
    ```bash  theme={null}
    python cookbook/11_models/google/gemini/imagen_tool.py
    ```
  </Step>
</Steps>
