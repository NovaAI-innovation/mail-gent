...
**Source:** https://docs.agno.com/cookbook/agents/startup-analyst-agent.md
**Section:** Docs
...
```python startup_analyst_agent.py theme={null}
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install scrapegraph-py agno openai
    ```
  </Step>
