...
**Source:** https://docs.agno.com/cookbook/workflows/company-description.md
**Section:** Docs
...
```
uv pip install agno openai firecrawl-py resend
```
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install -U agno openai fastapi firecrawl-py resend markdown ddgs
    ```
  </Step>
