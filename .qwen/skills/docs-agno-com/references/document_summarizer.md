...
**Source:** https://docs.agno.com/production/applications/document-summarizer.md
**Section:** Docs
...
> Structured document summaries with key points, entity extraction, and action item detection from PDFs, text, and URLs.
