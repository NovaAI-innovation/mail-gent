...
**Source:** https://docs.agno.com/agent-os/usage/remote-execution/remote-agent.md
**Section:** Docs
...
<Steps>
  ...
  <Step title="Start an AgentOS Server">
    Make sure you have an AgentOS server running with an agent that has `id="assistant-agent"`. See [Creating Your First OS](/agent-os/run-your-os) for setup instructions.
  </Step>
