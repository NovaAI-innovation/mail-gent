...
**Source:** https://docs.agno.com/observability/langfuse.md
**Section:** Docs
...
1. **Install Dependencies**
   ...
   ```bash  theme={null}
   uv pip install agno openai langfuse opentelemetry-sdk opentelemetry-exporter-otlp openinference-instrumentation-agno
   ```
