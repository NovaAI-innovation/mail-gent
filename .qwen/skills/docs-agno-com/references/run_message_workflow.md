...
**Source:** https://docs.agno.com/reference-api/schema/a2a/run-message-workflow.md
**Section:** Docs
...
````yaml post /a2a/workflows/{id}/v1/message:send
openapi: 3.1.0
info:
  title: Agno AgentOS
...
paths:
  /a2a/workflows/{id}/v1/message:send:
    post:
      ...
      description: >-
        Send a message to an Agno Workflow (non-streaming). The Workflow is
