...
**Source:** https://docs.agno.com/production/applications/recipe-agent.md
**Section:** Docs
...
> Multi-modal RAG agent that retrieves recipes from a knowledge base and generates visual cooking guides.
