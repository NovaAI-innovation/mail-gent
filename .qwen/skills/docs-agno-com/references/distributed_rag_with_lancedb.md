...
**Source:** https://docs.agno.com/knowledge/teams/distributed-rag-lancedb.md
**Section:** Docs
...
```python cookbook/02_examples/teams/distributed_rag/02_distributed_rag_lancedb.py theme={null}
"""
