...
**Source:** https://docs.agno.com/history/workflow/intent-routing-with-history.md
**Section:** Docs

**Description:** This example demonstrates how to use workflow history in intent routing.
