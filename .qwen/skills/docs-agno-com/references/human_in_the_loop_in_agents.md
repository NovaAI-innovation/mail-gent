...
**Source:** https://docs.agno.com/hitl/overview.md
**Section:** Docs
...
<CardGroup cols={3}>
  <Card title="User Confirmation" icon="circle-check" href="/hitl/user-confirmation">
    Require explicit user approval before executing tool calls
  </Card>

  <Card title="User Input" icon="keyboard" href="/hitl/user-input">
    Gather specific information from users during execution
  </Card>

  <Card title="Dynamic User Input" icon="comments" href="/hitl/dynamic-user-input">
    Let agents request user input dynamically when needed
  </Card>

  <Card title="External Tool Execution" icon="plug" href="/hitl/external-execution">
