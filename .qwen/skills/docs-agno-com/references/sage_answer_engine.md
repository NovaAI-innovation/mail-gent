...
**Source:** https://docs.agno.com/cookbook/streamlit/answer-engine.md
**Section:** Docs
...
> Perplexity-style search with web search and deep contextual analysis.
...
<video autoPlay muted controls className="w-full aspect-video" src="https://mintlify.s3.us-west-1.amazonaws.com/agno-v2/videos/answer-engine.mp4" />
