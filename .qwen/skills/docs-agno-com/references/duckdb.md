...
**Source:** https://docs.agno.com/tools/toolkits/database/duckdb.md
**Section:** Docs

**Description:** The DuckDbTools toolkit enables an Agent to run SQL and analyze data using DuckDb.
...
```python cookbook/14_tools/duckdb_tools.py theme={null}
