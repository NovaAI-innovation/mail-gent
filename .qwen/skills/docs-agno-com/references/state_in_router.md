...
**Source:** https://docs.agno.com/state/workflows/access-session-state-in-router-selector-function.md
**Section:** Docs

**Description:** This example demonstrates how to access the run context in the selector function of a router step
