...
**Source:** https://docs.agno.com/reference-api/schema/database/migrate-database.md
**Section:** Docs
...
````yaml post /databases/{db_id}/migrate
openapi: 3.1.0
info:
  title: Agno AgentOS
...
paths:
  /databases/{db_id}/migrate:
    post:
      ...
      description: >-
        Migrate the given database schema to the given target version. If a
        target version is not provided, the database will be migrated to the
        latest version.
