...
**Source:** https://docs.agno.com/state/workflows/access-session-state-in-condition-evaluator-function.md
**Section:** Docs

**Description:** This example demonstrates how to access the run context in the evaluator function of a condition step
