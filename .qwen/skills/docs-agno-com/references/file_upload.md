...
**Source:** https://docs.agno.com/models/providers/native/anthropic/usage/file-upload.md
**Section:** Docs
...
> Upload and reference files using Anthropic's Files API in Agno.
...
```python cookbook/11_models/anthropic/pdf_input_file_upload.py theme={null}
