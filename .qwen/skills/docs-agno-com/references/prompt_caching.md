...
**Source:** https://docs.agno.com/models/providers/native/anthropic/usage/prompt-caching.md
**Section:** Docs
...
```python cookbook/11_models/anthropic/prompt_caching_extended.py theme={null}
