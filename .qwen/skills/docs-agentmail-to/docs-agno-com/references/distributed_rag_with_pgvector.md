...
**Source:** https://docs.agno.com/knowledge/teams/distributed-rag-pgvector.md
**Section:** Docs
...
```python cookbook/02_examples/teams/distributed_rag/01_distributed_rag_pgvector.py theme={null}
"""
