...
**Source:** https://docs.agno.com/knowledge/vector-stores/pgvector/usage/pgvector-hybrid-search.md
**Section:** Docs
...
```python cookbook/08_knowledge/vector_db/pgvector/pgvector_hybrid_search.py theme={null}
