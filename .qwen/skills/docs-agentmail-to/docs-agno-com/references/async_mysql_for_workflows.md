...
**Source:** https://docs.agno.com/database/providers/async-mysql/usage/async-mysql-for-workflow.md
**Section:** Docs
...
Run `uv pip install openai sqlalchemy asyncmy agno` to install dependencies.
"""
