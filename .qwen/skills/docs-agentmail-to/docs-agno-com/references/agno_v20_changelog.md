...
**Source:** https://docs.agno.com/other/v2-changelog.md
**Section:** Docs
...
<Accordion title="Updates to Workflow Class">
  ...
  * Workflows "v1" has been completely removed and replaced with `Workflows v2`. See full details in the [Workflows](/workflows) section.
