...
**Source:** https://docs.agno.com/production/applications/research-agent.md
**Section:** Docs
...
> Autonomous web research agent using Parallel API with multi-source synthesis and citation tracking.
