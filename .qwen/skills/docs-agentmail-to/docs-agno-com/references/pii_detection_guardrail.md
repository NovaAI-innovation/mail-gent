...
**Source:** https://docs.agno.com/guardrails/usage/agent/pii-detection.md
**Section:** Docs

**Description:** This example demonstrates how to use Agno's built-in PII detection guardrail to protect sensitive data like SSNs, credit cards, emails, and phone numbers.
