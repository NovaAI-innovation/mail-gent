...
**Source:** https://docs.agno.com/guardrails/usage/team/prompt-injection.md
**Section:** Docs

**Description:** This example demonstrates how to use Agno's built-in prompt injection guardrail with a Team to stop injection attempts.
