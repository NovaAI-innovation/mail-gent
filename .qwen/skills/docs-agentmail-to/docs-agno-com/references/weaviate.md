...
**Source:** https://docs.agno.com/knowledge/vector-stores/weaviate/usage/weaviate-db.md
**Section:** Docs
...
```python cookbook/08_knowledge/vector_db/weaviate_db/weaviate_db.py theme={null}
