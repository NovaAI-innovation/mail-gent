...
**Source:** https://docs.agno.com/models/providers/native/google/usage/video-input-file-upload.md
**Section:** Docs
...
```python cookbook/11_models/google/gemini/video_input_file_upload.py theme={null}
import time
