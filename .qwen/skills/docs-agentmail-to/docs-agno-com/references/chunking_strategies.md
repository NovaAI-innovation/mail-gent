...
**Source:** https://docs.agno.com/cookbook/knowledge/chunking.md
**Section:** Docs
...
> Semantic, fixed-size, recursive, and custom chunking strategies for documents.
...
```python cookbook/07_knowledge/chunking/semantic_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/fixed_size_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/recursive_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/document_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/code_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/markdown_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/csv_row_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/agentic_chunking.py theme={null}
...
```python cookbook/07_knowledge/chunking/custom_strategy_example.py theme={null}
