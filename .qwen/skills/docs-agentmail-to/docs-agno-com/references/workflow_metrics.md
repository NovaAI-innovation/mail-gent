...
**Source:** https://docs.agno.com/sessions/metrics/workflow.md
**Section:** Docs

**Description:** Workflow run and session metrics for token usage and performance.
...
> Workflow run and session metrics for token usage and performance.
