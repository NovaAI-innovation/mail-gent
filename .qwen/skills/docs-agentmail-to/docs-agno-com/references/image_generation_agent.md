...
**Source:** https://docs.agno.com/models/providers/native/openai/responses/usage/image-generation-agent.md
**Section:** Docs
...
```python cookbook/11_models/openai/responses/image_generation_agent.py theme={null}
