...
**Source:** https://docs.agno.com/multimodal/team/usage/image-to-image-transformation.md
**Section:** Docs
...
This example demonstrates how an Agno Agent Team can collaborate to transform images using a style advisor to recommend transformations and an image transformer to apply AI-powered changes.

## Code

```python cookbook/02_examples/teams/multimodal/image_to_image_transformation.py theme={null}
