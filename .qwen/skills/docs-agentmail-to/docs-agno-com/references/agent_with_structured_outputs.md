...
**Source:** https://docs.agno.com/models/providers/native/openai/completion/usage/structured-output.md
**Section:** Docs
...
```python cookbook/11_models/openai/chat/structured_output.py theme={null}
...
guided_output_agent = Agent(
    model=OpenAIResponses(id="gpt-5.2", strict_output=False),
    description="You write movie scripts.",
    output_schema=MovieScript,
)
