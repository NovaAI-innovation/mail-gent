...
**Source:** https://docs.agno.com/agent-os/usage/mcp/mcp-tools-example.md
**Section:** Docs
...
```python cookbook/06_agent_os/mcp/mcp_tools_example.py theme={null}
...
<Steps>
  ...
  <Step title="Run Server">
    <CodeGroup>
      ```bash Mac theme={null}
      python cookbook/06_agent_os/mcp/mcp_tools_example.py
      ```
