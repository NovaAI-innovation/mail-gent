...
**Source:** https://docs.agno.com/database/providers/redis/usage/redis-for-team.md
**Section:** Docs
...
"""
Run: `uv pip install openai newspaper4k lxml_html_clean agno redis` to install the dependencies
"""
