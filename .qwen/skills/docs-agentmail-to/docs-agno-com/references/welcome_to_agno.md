...
**Source:** https://docs.agno.com/index.md
**Section:** Docs

**Description:** Build multi-agent systems that learn. Create agents, teams, and workflows with memory, knowledge, and 100+ tool integrations.
...
> Build multi-agent systems that learn. Create agents, teams, and workflows with memory, knowledge, and 100+ tool integrations.
...
export const highlightStyle = {
  backgroundColor: 'rgba(255, 64, 23, 0.2)',
  display: 'block',
};
...
export const codeTabs = [
    {
        ...
        code: (
          <>
            ...
            <span style={highlightStyle}>{'    '}learning=<span style={{color:'#ff4017'}}>True</span>,</span>
    ...
    },
    {
        ...
        code: (
          <>
            ...
            {'\n'}
            hn_researcher = Agent(name=<span style={{color:'#c3e88d'}}>"HackerNews Researcher"</span>, tools=[HackerNewsTools()]){'\n'}
            article_reader = Agent(name=<span style={{color:'#c3e88d'}}>"Article Reader"</span>, tools=[Newspaper4kTools()]){'\n'}
            {'\n'}
            team = Team({'\n'}
            {'    '}model=Claude(id=<span style={{color:'#c3e88d'}}>"claude-sonnet-4-5"</span>),{'\n'}
    ...
    },
    {
        ...
        code: (
          <>
            ...
            {'\n'}
            researcher = Agent(name=<span style={{color:'#c3e88d'}}>"Researcher"</span>, model=Claude(id=<span style={{color:'#c3e88d'}}>"claude-sonnet-4-5"</span>), tools=[DuckDuckGoTools()]){'\n'}
            writer = Agent(name=<span style={{color:'#c3e88d'}}>"Writer"</span>, model=Claude(id=<span style={{color:'#c3e88d'}}>"claude-sonnet-4-5"</span>), instructions=<span style={{color:'#c3e88d'}}>"Write engaging content"</span>){'\n'}
            {'\n'}
            workflow = Workflow({'\n'}
    ...
    },
    {
        ...
        code: (
          <>
            ...
            <span style={{color:'#ff4017'}}>from</span> agno.tools.mcp <span style={{color:'#ff4017'}}>import</span> MCPTools{'\n'}
            <span style={{color:'#ff4017'}}>from</span> agno.models.anthropic <span style={{color:'#ff4017'}}>import</span> Claude{'\n'}
            {'\n'}
            agent = Agent({'\n'}
            ...
            {'    '}tools=[MCPTools(url=<span style={{color:'#c3e88d'}}>"https://docs.agno.com/mcp"</span>)],{'\n'}
            {'    '}add_history_to_context=<span style={{color:'#ff4017'}}>True</span>,{'\n'}
            {'    '}markdown=<span style={{color:'#ff4017'}}>True</span>,{'\n'}
            ){'\n'}
            {'\n'}
    ...
    <section className="mt-20 flex flex-col items-center gap-6 text-center">
      ...
      <div className="mt-12 grid w-full max-w-5xl grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <a href="/agent-os/introduction" className="group relative flex flex-col gap-2 rounded-xl border border-[#e5e7eb] dark:border-zinc-700 bg-[#f6f7f9] dark:bg-zinc-900 p-5 transition hover:border-[#e5e7eb] dark:hover:border-zinc-600">
          ...
          <p className="text-xs leading-relaxed text-start text-zinc-500 dark:text-zinc-400">
            Turn your Agents into a production-ready API.
          </p>
        </a>

        {/* Production Card */}

        <a href="/production/overview" className="group relative flex flex-col gap-2 rounded-xl border border-[#e5e7eb] dark:border-zinc-700 bg-[#f6f7f9] dark:bg-zinc-900 p-5 transition hover:border-[#e5e7eb] dark:hover:border-zinc-600">
          <span className="pointer-events-none absolute -left-2 -top-2 h-4 w-4 border-l-2 border-t-2 border-[#ff4017] opacity-0 transition-opacity group-hover:opacity-100" />
          ...
          <h3 className="text-base font-semibold text-start text-zinc-900 dark:text-zinc-100">Production</h3>
    ...
    <section className="mt-20 pb-12">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-5 sm:px-8 lg:grid-cols-5 lg:px-10">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><a href="/production" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Overview</a></li>
            <li><a href="/production/templates" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Templates</a></li>
            <li><a href="/production/applications" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Applications</a></li>
            <li><a href="/production/interfaces" className="text-sm text-zinc-500 dark:text-zinc-400 transition hover:text-[#ff4017]">Interfaces</a></li>
          </ul>
        </div>
