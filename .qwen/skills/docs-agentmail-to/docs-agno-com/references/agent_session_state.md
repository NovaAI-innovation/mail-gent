...
**Source:** https://docs.agno.com/state/agent/overview.md
**Section:** Docs
...
* The `session_state` will be stored in your database. Subsequent runs **within the same session** will load the state from the database. See the [guide](/state/agent/overview#maintaining-state-across-multiple-runs-within-a-session) for more information.
