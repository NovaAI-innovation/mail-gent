...
**Source:** https://docs.agno.com/history/workflow/multi-purpose-cli.md
**Section:** Docs

**Description:** This example demonstrates how to use workflow history in a multi purpose CLI.
