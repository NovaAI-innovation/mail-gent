...
**Source:** https://docs.agno.com/other/v2-migration.md
**Section:** Docs
...
```python v2_run_output.py theme={null}
...
```python v1_context.py theme={null}
...
```python v2_dependencies.py theme={null}
from agno.agent import Agent
...
```python v1_storage.py theme={null}
from agno.agent import Agent
...
```python v2_storage.py theme={null}
from agno.agent import Agent
...
```python v2_storage_table_names.py theme={null}
...
```python v2_storage_all_tables.py theme={null}
db = SqliteDb(
    db_file="agno.db",
