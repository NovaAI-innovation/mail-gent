...
**Source:** https://docs.agno.com/reasoning/reasoning-models.md
**Section:** Docs
...
```python gpt_5_mini_with_tools.py theme={null}
from agno.agent import Agent
from agno.models.openai import OpenAIResponses
...
```python gpt_5_mini_with_reasoning_effort.py theme={null}
from agno.agent import Agent
from agno.models.openai import OpenAIResponses
from agno.tools.hackernews import HackerNewsTools
...
```python deepseek_r1_using_groq.py theme={null}
from agno.agent import Agent
...
```python streaming_reasoning.py theme={null}
from agno.agent import Agent
from agno.models.anthropic import Claude
...
```python capture_reasoning_events.py theme={null}
from agno.agent import Agent
from agno.models.anthropic import Claude
...
* View [Examples](/reasoning/usage/models/groq/groq)
