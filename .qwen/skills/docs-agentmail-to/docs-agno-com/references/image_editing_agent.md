...
**Source:** https://docs.agno.com/models/providers/native/google/usage/image-editing.md
**Section:** Docs
...
```python cookbook/11_models/google/gemini/image_editing.py theme={null}
...
<Steps>
  ...
  <Step title="Run Agent">
    ```bash  theme={null}
    python cookbook/11_models/google/gemini/image_editing.py
    ```
  </Step>
</Steps>
