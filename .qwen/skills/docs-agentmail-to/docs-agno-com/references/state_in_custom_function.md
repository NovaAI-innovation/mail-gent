...
**Source:** https://docs.agno.com/state/workflows/access-session-state-in-custom-python-function-step.md
**Section:** Docs

**Description:** This example demonstrates how to access the run context in a custom python function step
