...
**Source:** https://docs.agno.com/reasoning/usage/agents/capture-reasoning-content-cot.md
**Section:** Docs
...
<Steps>
  <Step title="Add the following code to your Python file">
    ...
    agent_with_reasoning_model = Agent(
        model=OpenAIResponses(id="gpt-5.2"),
        reasoning_model=OpenAIResponses(id="gpt-5.2"),  # Should default to manual COT
        markdown=True,
    )
