...
**Source:** https://docs.agno.com/tools/toolkits/web-scrape/browserbase.md
**Section:** Docs
...
```python cookbook/14_tools/browserbase_tools.py theme={null}
...
<Tip>View the [Startup Analyst MCP agent](/tools/mcp/usage/stagehand)</Tip>
