...
**Source:** https://docs.agno.com/models/providers/native/xai/usage/live-search-agent-stream.md
**Section:** Docs
...
```python cookbook/11_models/xai/live_search_agent_stream.py theme={null}
