...
**Source:** https://docs.agno.com/knowledge/vector-stores/chroma/usage/async-chroma-db.md
**Section:** Docs
...
```python cookbook/08_knowledge/vector_db/chroma_db/async_chroma_db.py theme={null}
