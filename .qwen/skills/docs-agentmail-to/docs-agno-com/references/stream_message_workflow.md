...
**Source:** https://docs.agno.com/reference-api/schema/a2a/stream-message-workflow.md
**Section:** Docs
...
````yaml post /a2a/workflows/{id}/v1/message:stream
openapi: 3.1.0
info:
  title: Agno AgentOS
...
paths:
  /a2a/workflows/{id}/v1/message:stream:
    post:
      ...
      description: >-
        Stream a message to an Agno Workflow (streaming). The Workflow is
        identified via the path parameter '{id}'. Optional: Pass user ID via
