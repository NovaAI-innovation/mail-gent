...
**Source:** https://docs.agno.com/agent-os/tracing/usage/tracing-with-multi-db-scenario-and-tracing-flag.md
**Section:** Docs
...
This example shows how to configure tracing when agents have separate databases using the `tracing=True` flag. A dedicated `db` ensures all traces are stored in one central location.
