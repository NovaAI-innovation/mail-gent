...
**Source:** https://docs.agno.com/tools/toolkits/social/x.md
**Section:** Docs
...
```python cookbook/14_tools/x_tools.py theme={null}
...
<Note>
  ...
  Check out the [Tweet Analysis Agent](/cookbook/agents/social_media_agent)
