...
**Source:** https://docs.agno.com/reference-api/schema/a2a/run-message-team.md
**Section:** Docs
...
````yaml post /a2a/teams/{id}/v1/message:send
openapi: 3.1.0
info:
  title: Agno AgentOS
...
paths:
  /a2a/teams/{id}/v1/message:send:
    post:
      ...
      description: >-
        Send a message to an Agno Team (non-streaming). The Team is identified
