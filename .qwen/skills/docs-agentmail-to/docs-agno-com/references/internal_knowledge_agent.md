...
**Source:** https://docs.agno.com/production/applications/knowledge-agent.md
**Section:** Docs
...
> RAG-powered agent for answering questions from company docs with source citations.
