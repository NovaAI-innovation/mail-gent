...
**Source:** https://docs.agno.com/hitl/usage/user-input-required-async.md
**Section:** Docs

**Description:** This example demonstrates how to use the requires_user_input parameter with asynchronous operations. It shows how to collect specific user input fields in an async environment.
