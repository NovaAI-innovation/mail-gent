...
**Source:** https://docs.agno.com/multimodal/agent/usage/video-to-shorts.md
**Section:** Docs
...
"""
1. Install dependencies using: `uv pip install opencv-python google-geneai sqlalchemy`
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install -U agno opencv-python sqlalchemy
    ```
  </Step>
  ...
  <Step title="Run Agent">
    ```bash  theme={null}
    python cookbook/03_agents/multimodal/video_to_shorts.py
    ```
  </Step>
</Steps>
