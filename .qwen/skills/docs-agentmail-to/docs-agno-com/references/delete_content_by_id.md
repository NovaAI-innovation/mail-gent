...
**Source:** https://docs.agno.com/reference-api/schema/knowledge/delete-content-by-id.md
**Section:** Docs
...
paths:
  /knowledge/content/{content_id}:
    delete:
      ...
      description: >-
        Permanently remove a specific content item from the knowledge base. This
