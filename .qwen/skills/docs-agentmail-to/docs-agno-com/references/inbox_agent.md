...
**Source:** https://docs.agno.com/production/applications/inbox-agent.md
**Section:** Docs
...
> Gmail assistant that triages emails, drafts replies, and flags urgent items with safety controls.
...
* Categorization (urgent, action\_required, fyi, newsletter, spam)
* Priority scoring
...
| **action\_required** | Requests, questions             | Queue for response   |
