...
**Source:** https://docs.agno.com/models/providers/native/google/usage/audio-input-file-upload.md
**Section:** Docs
...
```python cookbook/11_models/google/gemini/audio_input_file_upload.py theme={null}
