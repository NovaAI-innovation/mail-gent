...
**Source:** https://docs.agno.com/models/providers/native/mistral/usage/image-ocr-with-structured-output.md
**Section:** Docs
...
```python cookbook/11_models/mistral/image_ocr_with_structured_output.py theme={null}
...
<Steps>
  ...
  <Step title="Run Agent">
    ```bash  theme={null}
    python cookbook/11_models/mistral/image_ocr_with_structured_output.py
    ```
  </Step>
</Steps>
