...
**Source:** https://docs.agno.com/reference/teams/team.md
**Section:** Docs
...
| `member_timeout`                   | `Optional[float]`                                                    | `None`     | Timeout in seconds for member delegations. Prevents hanging on unresponsive members                                                                                                                                  |
...
| `max_interactions_to_share`        | `Optional[int]`                                                      | `None`     | Maximum number of member interactions to share when `share_member_interactions=True`. Limits context size to prevent context explosion                                                                               |
