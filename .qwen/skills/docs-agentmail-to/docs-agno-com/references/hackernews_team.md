...
**Source:** https://docs.agno.com/cookbook/teams/hackernews_team.md
**Section:** Docs
...
```python hackernews_team.py theme={null}
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install -U agno openai ddgs newspaper4k lxml_html_clean
    ```
  </Step>
...
* Explore [Input & Output](/input-output/overview) for custom data schemas
