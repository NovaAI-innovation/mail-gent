...
**Source:** https://docs.agno.com/models/providers/native/openai/completion/usage/audio-output-agent.md
**Section:** Docs
...
```python cookbook/11_models/openai/chat/audio_output_agent.py theme={null}
