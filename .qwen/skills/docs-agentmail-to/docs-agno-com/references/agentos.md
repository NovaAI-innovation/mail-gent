...
**Source:** https://docs.agno.com/reference/agent-os/agent-os.md
**Section:** Docs
...
| `registry`                | `Optional[str]`                                             | `None`               | What to do when a route conflict is detected in case a custom base\_app is provided.                      |
