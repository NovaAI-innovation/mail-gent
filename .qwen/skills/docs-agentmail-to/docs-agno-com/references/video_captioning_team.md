...
**Source:** https://docs.agno.com/multimodal/team/usage/video-caption-generation.md
**Section:** Docs
...
```python cookbook/02_examples/teams/multimodal/video_caption_generation.py theme={null}
...
<Steps>
  ...
  <Step title="Install required libraries">
    ```bash  theme={null}
    uv pip install agno moviepy ffmpeg-python
    ```
  </Step>
