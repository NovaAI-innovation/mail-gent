...
**Source:** https://docs.agno.com/cookbook/models/anthropic.md
**Section:** Docs

**Description:** Use Claude Sonnet and Opus models with Agno agents.
...
> Use Claude Sonnet and Opus models with Agno agents.
