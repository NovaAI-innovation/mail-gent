...
**Source:** https://docs.agno.com/cookbook/agents/deep_knowledge.md
**Section:** Docs
...
```python cookbook/01_showcase/01_agents/deep_knowledge_agent.py theme={null}
...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash  theme={null}
    uv pip install -U agno openai lancedb tantivy inquirer
    ```
  </Step>
  ...
  <Step title="Run Agent">
    <CodeGroup>
      ```bash Mac theme={null}
      python cookbook/01_showcase/01_agents/deep_knowledge_agent.py
      ```
